  ...
  const handleEnterKeyPress = (
    ...
    if (event.key === 'Enter') {
      ...
      switch (currentField) {
        ...
        case 'price_each':
          if (
            currentIndex === innerArray.length - 1 &&
                              ...
                              <TextField
                                ...
                                onKeyPress={(e) => {
                                  if (
                                    ...
                                    outerItem.items?.length - 1 == innerIndex
                                  )
                                    handleLotNoKeyPress(e, innerIndex);
                                }}
                                onKeyDown={(event) => {
                                  handleEnterKeyPress(
                                    event,
